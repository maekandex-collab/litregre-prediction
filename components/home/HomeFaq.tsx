...
const FAQS = [
  ...
  {
    q: "How do I register?",
    a: "Open your USSD/SMS registration link (it includes your phone number). The number is locked — set a PIN, accept the terms, and your account is created. Then sign in with phone + PIN.",
  },
];
