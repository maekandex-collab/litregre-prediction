...
const SLIDES: SlideData[] = [
  ...
  {
    title: "Special",
    highlight: "Betting Markets",
    subtitle: "Goal scorers, cards & corners, BTTS, Over 2.5, and multi-sport predictions in one powerful hub.",
    cta: "Explore Specials",
    href: "/predictions/special",
    icon: <Zap size={24} />,
    bgIcon: <Zap size={140} />,
    gradient: "from-[#064e3b] via-[#047857] to-[#0891b2]",
    badges: ["Goal Scorers", "Cards & Corners", "BTTS"],
  },
  {
    title: "Accumulator",
          ...
          <SwiperSlide key={slide.title}>
            <div className={`relative bg-gradient-to-br ${slide.gradient} min-h-[220px] sm:min-h-[240px] overflow-hidden`}>
              ...
              <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div className="absolute top-[-30%] right-[10%] w-48 h-48 rounded-full bg-white/[0.06] blur-3xl" />
                <div className="absolute bottom-[-20%] left-[5%] w-36 h-36 rounded-full bg-white/[0.04] blur-2xl" />
                <div className="absolute top-[20%] left-[40%] w-24 h-24 rounded-full bg-white/[0.03] blur-xl float-animation" />
              </div>
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-start gap-5 p-6 sm:p-8 h-full">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-9 h-9 rounded-lg bg-white/15 backdrop-blur-sm flex items-center justify-center text-white border border-white/10">
                      {slide.icon}
                    </div>
                    <div className="flex gap-1.5">
                      {slide.badges?.slice(0, 2).map((badge) => (
                        <span
                          key={badge}
                  ...
                  <Link
                    href={slide.href}
                    className="group inline-flex items-center gap-2 bg-white text-gray-900 text-xs sm:text-sm font-bold px-5 py-2.5 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-white/20 hover:scale-[1.03] active:scale-[0.98]"
                  >
                    {slide.cta}
                ...
                <div className="flex-shrink-0 hidden sm:flex flex-col items-center justify-center">
                  <div className="relative">
                    ...
                    <div className="relative w-20 h-20 lg:w-24 lg:h-24 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white/40 float-animation">
                      {slide.icon}
                    </div>
                  </div>
                </div>
