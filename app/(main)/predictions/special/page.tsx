...
const DAILY_SPECIAL_SUB_TABS: { id: DailySpecialSub; label: string }[] = [
  { id: "1x2", label: "1X2" },
  { id: "btts", label: "BTS" },
...
function parseTabFromQuery(tab: string | null): {
  ...
  if (tab === "1x2" || tab === "btts" || tab === "bts" || tab === "over_15" || tab === "over_25") {
      ...
      <div className="bg-gradient-to-br from-[#0f2744] via-[#1a3a6b] to-[#0d4a8a] rounded-2xl p-6 sm:p-8 mb-6 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-sm max-w-xl leading-relaxed">
            Expert picks across daily special markets — 1X2, BTS, Over 1.5, Over 2.5, basketball, tennis, goal scorers, cards & corners, and MMA.
          </p>
        </div>
      </div>
